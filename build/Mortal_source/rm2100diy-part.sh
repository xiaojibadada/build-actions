...
uci set system.@system[0].hostname='desktop-dajiba'                            # 修改主机名称为OpenWrt-123
EOF
...
sed -i 's/R6Naic$ejtqsb/0sRiB5PGtDs/eq/:18895/g' package/emortal/default-settings/files/zzz-default-settings                                                        # 设置密码为空
